...
interface ProvinceHeroBentoProps {
  data: ProvinceLandingData
}

export const ProvinceHeroBento: React.FC<ProvinceHeroBentoProps> = ({ data }) => {
      ...
      <div className="relative rounded-3xl overflow-hidden bg-stone-900 shadow-xl border border-stone-200 aspect-16/9 sm:aspect-21/9 min-h-[280px] sm:min-h-[420px] lg:min-h-[480px]">
        {currentImage && (
          <img
            ...
            alt={currentImage.title || data.province.name}
