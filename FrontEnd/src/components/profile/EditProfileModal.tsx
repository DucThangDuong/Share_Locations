...
export const EditProfileModal: React.FC<EditProfileModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div
        className="w-full max-w-lg bg-white rounded-lg border border-slate-200/80 overflow-hidden animate-in zoom-in-95 duration-150"
        role="dialog"
        aria-modal="true"
      >
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-11 pl-10 pr-4 text-xs sm:text-sm border border-slate-200 rounded-lg bg-slate-50/80 focus:bg-white focus:ring-2 focus:ring-primary-container/20 focus:border-primary-container outline-hidden transition-all"
                  />
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    className="w-full pl-10 pr-4 py-2.5 text-xs sm:text-sm border border-slate-200 rounded-lg bg-slate-50/80 focus:bg-white focus:ring-2 focus:ring-primary-container/20 focus:border-primary-container outline-hidden transition-all resize-none"
                  />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-3.5 py-2 text-xs font-semibold bg-slate-100 hover:bg-slate-200/70 text-slate-700 rounded-lg transition-colors flex items-center gap-1.5 cursor-pointer"
                    >
                    ...
                    {avatarFile && (
                      <button
                        ...
                        className="px-2.5 py-2 text-xs text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-1 cursor-pointer"
                      >
          ...
          <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-5 py-2.5 text-xs font-semibold text-white bg-primary-container hover:bg-primary-hover disabled:opacity-70 rounded-lg active-press transition-all cursor-pointer flex items-center gap-2"
            >
