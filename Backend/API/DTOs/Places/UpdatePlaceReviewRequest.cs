...
public class UpdatePlaceReviewRequest
{
    [BindFrom("id")]
...
public class UpdatePlaceReviewRequestValidator : Validator<UpdatePlaceReviewRequest>
{
    ...
    public UpdatePlaceReviewRequestValidator()
    {
        RuleFor(x => x.Id)
            .GreaterThan(0)
